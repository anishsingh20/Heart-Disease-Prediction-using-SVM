...
So amongst a set of competing hypothesis $h_i(x)$ we want to choose which maximizes the margin between both the classes on wither side of the separating hyperplane.
...
svmPredictionprob <- predict(svmModel, testData2, type='prob')
